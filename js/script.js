...
function displayButton() {
    for (let i = 0; i < vaccineBtn.length; i++) {
        if (array[i].vaccine === true) {
            document.getElementsByClassName("vaccine")[i].innerHTML = `<button type="" class="btn btn-success w-100 rounded-pill vaccine-btn"><h4>Vaccine <img src="../pics/tnailup.png" alt="" class="iconica"></h4></button>`;
        }
        else if (array[i].vaccine === false) {
            document.getElementsByClassName("vaccine")[i].innerHTML = `<button type="" class="btn btn-danger w-100 rounded-pill vaccine-btn"><h4>Vaccine  <img src="../pics/tnaildown.png" alt="" class="iconica"></h4></button>`;
        }
        ;
    }
    ;
